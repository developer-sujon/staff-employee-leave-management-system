...
const LeaveHodCreateUpdatePage = () => {
  ...
  const validationSchema = yup.object().shape({
    ...
    HodStatus: yup.string().required("Please Select Hod Status"),
    HodRemark: yup.string().required("Please Enter Hod Remark"),
  });
                    ...
                    <Row>
                      <Col xl={12}>
                        ...
                        <FormInput
                          name="HodStatus"
                          label={t("Hod Status")}
                          placeholder={t("Select Hod Status")}
                          containerClass={"mb-3"}
                      ...
                      <Col xl={12}>
                        <FormInput
                          name="HodRemark"
                          label={t("Hod Remark")}
                          placeholder={t("Enter Hod Remark")}
                          containerClass={"mb-3"}
